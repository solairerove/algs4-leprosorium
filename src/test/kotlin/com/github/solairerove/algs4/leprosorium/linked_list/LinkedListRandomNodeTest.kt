...
class LinkedListRandomNodeTest : FunSpec({
    ...
    test("linked list random node basic test") {
        ...
        val linkedListRandomNodeSampling = LinkedListRandomNodeUsingReservoirSampling(head)
        listOf(1, 2, 3).contains(linkedListRandomNodeSampling.getRandom()) shouldBe true  // return 1
        listOf(1, 2, 3).contains(linkedListRandomNodeSampling.getRandom()) shouldBe true  // return 3
        listOf(1, 2, 3).contains(linkedListRandomNodeSampling.getRandom()) shouldBe true  // return 2
        listOf(1, 2, 3).contains(linkedListRandomNodeSampling.getRandom()) shouldBe true  // return 2
        listOf(1, 2, 3).contains(linkedListRandomNodeSampling.getRandom()) shouldBe true  // return 3
